...
class Tplink_WR740N(TplinkBase):
    ...
    def get_wireless_settings(self):
        ...
        return self._parse_wireless_settings(html_settings, html_security)
    ...
    def push_wireless_settings(self, settings):
        ...
        get_params_security = self._generate_wireless_security_data(settings)
    ...
    @classmethod
    def _parse_wireless_settings(cls, html_settings, html_security):
        ...
        security_array = cls._extract_js_array_data(html_security, 'wlanPara')
        wlan_list_array = cls._extract_js_array_data(html_security, 'wlanList')
