...
class Tplink_WR340G(TplinkBase):
    ...
    def get_wireless_settings(self):
        ...
        return self._parse_wireless_settings_WR340G(html_settings)

    def push_wireless_settings(self, settings):
        get_params_settings = self._generate_wireless_settings_data(settings)
    ...
    @classmethod
    def _parse_wireless_settings_WR340G(cls, html_settings):
        ...
        settings_array = cls._extract_js_array_data(html_settings, 'wlanPara')
        wlan_list_array = cls._extract_js_array_data(html_settings, 'wlanList')
